...
| [EP03-Serverless-Data-Pipeline(NYC-dataset-S3-Glue-Athena-Quicksight)](./EP03-Serverless-Data-Pipeline(NYC-dataset-S3-Glue-Athena-Quicksight)/) | Build a serverless data pipeline using AWS services to ingest, process, query, and visualise real-world NYC taxi trip data. | S3, Glue, Lambda, Athena, QuickSight | 🔗 [Episode 3](https://youtu.be/AtACZVoVCY4) |
| ... | ... | ... | ... |
